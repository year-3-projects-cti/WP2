      ...
      <InterfaceNav />
        ...
        <main class="main-content">
          <div class="glass-panel">
            ...
            <div class="add-course-container" v-if="isAdmin">
...
// Fallback: Încarcă user-ul din localStorage dacă nu e deja definit
if (!usersStore.user && localStorage.getItem('user')) {
  try {
    usersStore.user = JSON.parse(localStorage.getItem('user'));
  } catch (e) {
...
onMounted(async () => {
  ...
  console.log('Loaded user from store:', usersStore.user);

  if (usersStore.user?.role === 'TEACHER') {
    newCourse.value.teacherId = usersStore.user.id;
  }
});
</script>
